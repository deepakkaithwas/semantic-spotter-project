...
- Clone the github repository
  ```shell
  $ git clone https://github.com/deepakkaithwas/semantic-spotter-project.git
  ```
- Open
  the [notebook](https://github.com/deepakkaithwas/semantic-spotter-project/blob/main/semantic-spotter-langchain-notebook.ipynb)
